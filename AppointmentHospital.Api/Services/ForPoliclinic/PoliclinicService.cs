...
namespace AppointmentHospital.Api.Services.ForPoliclinic
{
    public class PoliclinicService : IPoliclinicService
    {
        ...
        {
            var result = await _context.Policlinics.FirstOrDefaultAsync(x => x.PoliclinicId == policid);
            if (result == null)
            {
                return new ServiceResponse<Policlinic>
                {
        ...
        {
            var result = await _context.Policlinics.FindAsync(policlinic.PoliclinicId);
            if (result == null)
            {
                return new ServiceResponse<Policlinic>
                {
